...
{
	__weak ScatteredAppDelegate *weakSelf = self;
			...
			if (image)
			{
				[weakSelf->processingQueue addOperationWithBlock:^{
					...
					[[NSOperationQueue mainQueue] addOperationWithBlock:^(void) {
						...
						[weakSelf setText:[NSString stringWithFormat:@"%0.1fs",
