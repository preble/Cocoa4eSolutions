		   ...
		   context:(void *)v
{
	...
	else if (choice == NSAlertOtherReturn)
	{
		...
		{
			[person setExpectedRaise:0];
		}
		// We could just [tableView reloadData] here, but it is a little more stylish to reload specific rows:
		[tableView reloadDataForRowIndexes:[tableView selectedRowIndexes]
